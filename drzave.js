const countries = {
   ...
   // Pretvaranje objekta u niz parova [kod, ime] i sortiranje prema imenu
const sortedCountries = Object.entries(countries).sort((a, b) => {
    const nameA = a[1].toLowerCase(); // a[1] je srpsko ime zemlje
    const nameB = b[1].toLowerCase(); // b[1] je srpsko ime zemlje
    if (nameA < nameB) return -1;
    if (nameA > nameB) return 1;
    return 0;
  });
  
  // Generisanje HTML-a za dropdown
  ...
  sortedCountries.forEach(([code, name]) => {
    ...
    if (name === "Srbija") {
        option.selected = true; // Postavi Srbiju kao aktivnu
    }
